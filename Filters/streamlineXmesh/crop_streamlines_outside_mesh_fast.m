function [tract, orig_sl_ind, xverts, xpoints] = crop_streamlines_outside_mesh_fast(V, F, tract, inside, outer_intersection)
    ...
    % expand the outputs
    assert(~isempty(rsl), 'No streamlines have survived GWG filtering');        
